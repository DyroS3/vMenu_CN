    ...
    public class BannedPlayers
    {
        ...
        private void CreateMenu()
        {
            ...
            menu.OnItemSelect += (sender, item, index) =>
            {
                ...
                {
                    bannedUntilItem.Label = currentRecord.bannedUntil.Date.ToString("yyyy-MM-dd");
                }

                bannedUntilItem.Description = "此玩家将于: " + currentRecord.bannedUntil.Date.ToString() + " 被自动解除封禁.";
